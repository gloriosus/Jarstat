...
public class GetRootsHandler : IRequestHandler<GetRootsQuery, Result<List<Item>>>
{
    private readonly IItemRepository _itemRepository;

    public GetRootsHandler(IItemRepository itemRepository) => _itemRepository = itemRepository;

    public async Task<Result<List<Item>>> Handle(GetRootsQuery request, CancellationToken cancellationToken)
    {
